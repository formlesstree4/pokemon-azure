...
namespace Pokemon_Base_Stats_Editor
{
    public partial class Main : Form
    {
        ...
        private static BaseStat GetBaseStats(int id, ushort form)
        {
        ...
        public static void SetBaseStats(int id, ushort form, BaseStat bs)
        {
            int index = Find(id, form);
            basestats[index] = bs;
        }
        private static int Find(int id, ushort form)
        {
            return basestats.FindIndex(delegate(BaseStat b)
            {
                return (b.ID == id) && (b.FormID == (byte)form);
            });            
        }
