...
namespace PokeEngine.Pokemon
{
    ...
    public class ActivePokemon
    {
        ...
        public void levelUp()
        {
            Screens.ScreenHandler.PushScreen(
                new Screens.DialogBox(
                    Screens.ScreenHandler.graphics,
                    Screens.ScreenHandler.content,
                    Screens.ScreenHandler.font,
                    String.Format(
        ...
        public void changeBasePokemon(String name)
        {
            ...
            {
                name = baseStat.Name;   //change the pokemon's name to the new species' name
            }
        }
