...
namespace LiveMapMaker.Tools
{
    public static class ModelTool
    {
        ...
        public static void PlaceModel()
        {
            ...
            //make sure there is not already a duplicate scenery there
            if (game.world.currentArea.tile[game.selectedX, game.selectedY].sceneryObject == editor.sceneryList[(String)editor.sceneryBox.SelectedItem])
            {
                return;
            }
            ...
            if(!game.world.currentArea.scenery.Contains(scenery))
            {
