...
namespace PokeEngine.Screens
{
    class OptionScreen : Screen
    {
        ...
        private void UpdateKeyOption(int index)
        {
            switch (index)
            {
                case 0: keyconfigMenu.ChangeOption(index, String.Format("Up: {0}", KeyConfig.KeyList[0].ToString())); break;
                case 1: keyconfigMenu.ChangeOption(index, String.Format("Down: {0}", KeyConfig.KeyList[1].ToString())); break;
                case 2: keyconfigMenu.ChangeOption(index, String.Format("Left: {0}", KeyConfig.KeyList[2].ToString())); break;
                case 3: keyconfigMenu.ChangeOption(index, String.Format("Right: {0}", KeyConfig.KeyList[3].ToString())); break;
                case 4: keyconfigMenu.ChangeOption(index, String.Format("Action (Select): {0}", KeyConfig.KeyList[4].ToString())); break;
                case 5: keyconfigMenu.ChangeOption(index, String.Format("Cancel (Back): {0}", KeyConfig.KeyList[5].ToString())); break;
                case 6: keyconfigMenu.ChangeOption(index, String.Format("Menu: {0}", KeyConfig.KeyList[6].ToString())); break;
                case 7: keyconfigMenu.ChangeOption(index, String.Format("Item: {0}", KeyConfig.KeyList[7].ToString())); break;
            }
        }
