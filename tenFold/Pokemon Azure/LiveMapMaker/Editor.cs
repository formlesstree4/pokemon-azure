...
namespace LiveMapMaker
{
    public partial class Editor : Form
    {
        ...
        public int historySize = 10;// size of the history
        ...
        private void btn_BrowseTileDirectory_Click(object sender, EventArgs e)
        {
            ...
            pbar_ExtractionProgress.Maximum = ((spriteSheet.Height / 32) * (spriteSheet.Width / 32));
            ...
            for (int y = 0; y < (spriteSheet.Height / 32); y++)
            {
                for (int x = 0; x < (spriteSheet.Width / 32); x++)
                {
                    ...
                    tempImage = CopyImage(spriteSheet, new System.Drawing.Rectangle((x * 32), (y * 32), 32, 32));
                    tempImage.Save(s);
